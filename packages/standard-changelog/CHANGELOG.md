...
## [8.1.0](https://github.com/ItsJoseph470/conventional-changelog/compare/standard-changelog-v8.1.0...standard-changelog-v8.1.0) (2026-08-10)
...
* feat!(standard-changelog): small refactoring (#1111) ([574d29d](https://github.com/ItsJoseph470/conventional-changelog/commit/574d29dcfea0ff914d12d21e347ac71d76bfd7f7)), references [#1111](https://github.com/ItsJoseph470/conventional-changelog/issues/1111)

### Features

* default to overwriting and/or generating CHANGELOG.md. ([8678b62](https://github.com/ItsJoseph470/conventional-changelog/commit/8678b62271a1396518d7124c379897e4d7260c78))
...
* init ([a331bd0](https://github.com/ItsJoseph470/conventional-changelog/commit/a331bd02ae5145024bb42f894367145d22b49e3d)), closes [ajoslin/conventional-changelog#84](https://github.com/ajoslin/conventional-changelog/issues/84)
* migrate from chalk to picocolors ([#1074](https://github.com/ItsJoseph470/conventional-changelog/issues/1074)) ([c746701](https://github.com/ItsJoseph470/conventional-changelog/commit/c7467017584616037d9ed8cb926b8e99a161cc5e))
...
* update CLI tools to support lerna tags ([#175](https://github.com/ItsJoseph470/conventional-changelog/issues/175)) ([1fc5612](https://github.com/ItsJoseph470/conventional-changelog/commit/1fc561217d79978b9d0248612b75e87c4b4a2d0b))

### Bug Fixes

* add types for cli flags ([#551](https://github.com/ItsJoseph470/conventional-changelog/issues/551)) ([bf1d64a](https://github.com/ItsJoseph470/conventional-changelog/commit/bf1d64aeaf8f262d4b2beec02d2aebb78df7343b))
...
* update dependency figures to v3 ([#453](https://github.com/ItsJoseph470/conventional-changelog/issues/453)) ([099b5b5](https://github.com/ItsJoseph470/conventional-changelog/commit/099b5b58138139ca6d2a9ade58f0c6282aef9ad4))
...
* update dependency rimraf to v3 ([#514](https://github.com/ItsJoseph470/conventional-changelog/issues/514)) ([c7e1706](https://github.com/ItsJoseph470/conventional-changelog/commit/c7e17062a7a38a194164c47d0e88fcbe3fb6490c))
* update dependency tempfile to v3 ([#459](https://github.com/ItsJoseph470/conventional-changelog/issues/459)) ([c0bac28](https://github.com/ItsJoseph470/conventional-changelog/commit/c0bac28c45dd4d1516330b83d12f16f6ad88664b))
* update dependency tempfile to v5 ([#1041](https://github.com/ItsJoseph470/conventional-changelog/issues/1041)) ([c026e30](https://github.com/ItsJoseph470/conventional-changelog/commit/c026e3006cd4cc2d49812ff8a4cfa9f3d4b3795c))
* update lodash to fix security issues ([#535](https://github.com/ItsJoseph470/conventional-changelog/issues/535)) ([ac43f51](https://github.com/ItsJoseph470/conventional-changelog/commit/ac43f51de1f3b597c32f7f8442917a2d06199018))
* update yargs-parser to move off a flagged-vulnerable version. ([#635](https://github.com/ItsJoseph470/conventional-changelog/issues/635)) ([aafc0f0](https://github.com/ItsJoseph470/conventional-changelog/commit/aafc0f00412c3e4b23b8418300e5a570a48fe24d))
